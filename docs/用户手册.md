...
下载地址：[DocsFabrica-Windows-Setup-v0.5.29.exe](https://github.com/ShangyuanYU/DocsFabrica-Core/releases/download/v0.5.29/DocsFabrica-Windows-Setup-v0.5.29.exe)

1. 完全退出 Microsoft Word。可在任务栏右键 Word 并选择退出，确保 Word 进程已结束。
2. 下载 [DocsFabrica Windows 安装包 v0.5.29](https://github.com/ShangyuanYU/DocsFabrica-Core/releases/download/v0.5.29/DocsFabrica-Windows-Setup-v0.5.29.exe)，并双击运行 `DocsFabrica-Windows-Setup-v0.5.29.exe`。
3. 按安装向导点击 `下一步 -> 安装`，等待安装完成。
4. 安装完成后，再次完全退出 Word 并重新打开。
5. 在 Word 的 `开始` 选项卡点击 `DocsFabrica` 按钮。
6. 若侧边栏空白，先双击桌面 `DocsFabrica-start.cmd`，再重新打开 DocsFabrica 面板。
7. 首次使用时，在侧边栏 `设置` 中配置 API Key 并保存。
...
安装验证：打开 Word，进入 DocsFabrica 侧边栏，在 `设置` 页面底部应显示 `UI v0.5.29`。

![Windows 安装教程](assets/demo/windows-install-github.gif)
...
![在 Word 中加载 DocsFabrica](assets/demo/word-addin-github.gif)
...
![配置 DeepSeek API Key](assets/demo/配置key教程-github.gif)
...
![问答模式教程](assets/demo/问答模式教程-github.gif)
...
![修订模式教程](assets/demo/修订模式教程-github.gif)
...
![使用选区教程](assets/demo/使用选取教程-github.gif)
...
如果在使用过程中遇到问题，或希望提出功能建议，请通过 GitHub Issues 留言：

[提交问题或建议](https://github.com/ShangyuanYU/DocsFabrica-Core/issues)
